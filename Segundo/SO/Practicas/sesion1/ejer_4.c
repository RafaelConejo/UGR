...
//Otra opcion:
//Compruebo el IFMT (filetype) si es igual que el flag de archivo regular (es en verda lo mismo que arriba pero con binario a cara perro)
