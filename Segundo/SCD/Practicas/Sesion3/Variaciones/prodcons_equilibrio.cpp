...
//mpicxx -std=c++11 -g -Wall -o prodcons_equilibrio prodcons_equilibrio.cpp
//mpirun -np  11 ./prodcons_equilibrio
...
const int
   ...
   np                    = 6,           //np, numero de productores
   nc                    = 4,           //nc, numero de consumidores
   id_buffer             = np + nc,
   ...
   int calcular_id_productor(int id_origen){
      return id_origen + 4;
   }
   ...
   {
      static int contador = (id_productor-4) * items_producidos;
