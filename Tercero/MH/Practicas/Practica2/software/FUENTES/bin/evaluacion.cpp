...
int evaluacion::calcularRestricciones(vector<size_t> individuo){
   int no_cumplo = 0;
...
vector<int> evaluacion::elementosCadaCluster(vector<size_t> individuo){
...
vector<vector<double>> evaluacion::obtenerCentroide(vector<size_t> individuo){
   int cluster_actual = 0;
...
double evaluacion::distanciaMedia(vector<vector<double>> centroides, vector<size_t> individuo){
   int cluster_actual = 0;
...
double evaluacion::funcionObjetivo(vector<size_t> individuo){
   evaluaciones++;
