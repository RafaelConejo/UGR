...
int evaluacion::calcularRestricciones(vector<double> individuo){
   int no_cumplo = 0;
...
vector<int> evaluacion::elementosCadaCluster(vector<double> individuo){
...
vector<vector<double>> evaluacion::obtenerCentroide(vector<double> individuo){
   int cluster_actual = 0;
...
double evaluacion::distanciaMedia(vector<vector<double>> centroides, vector<double> individuo){
   int cluster_actual = 0;
...
double evaluacion::funcionObjetivo(vector<double> individuo){
   evaluaciones++;
