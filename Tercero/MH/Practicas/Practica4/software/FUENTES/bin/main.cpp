...
int main(int argc, char const *argv[]) {
	...
	int algoritmo;
	std::cout << "Introduzca 1 si desea el algoritmo GSO con PSO: " << '\n';
	std::cout << "Introduzca 2 si desea el algoritmo GSO con BL: " << '\n';
	std::cout << "Introduzca 3 si desea el algoritmo GSO con mutarBrusco: " << '\n';
	std::cin >> algoritmo;
	...
	switch (algoritmo) {
		case 1:{
			...
			vector<double> solucion = gso.algoritmo_GSO();
		...
		case 2:{
			...
			high_resolution_clock::time_point t1 = high_resolution_clock::now();
			vector<double> solucion = gso.algoritmo_GSO_BL();
			high_resolution_clock::time_point t2 = high_resolution_clock::now();
		...
		case 3:{
			...
			high_resolution_clock::time_point t1 = high_resolution_clock::now();
			vector<double> solucion = gso.algoritmo_GSO_BL_mutacion();
			high_resolution_clock::time_point t2 = high_resolution_clock::now();
